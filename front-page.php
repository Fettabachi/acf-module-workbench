...
<main id="primary" class="site-main workbench-home">
	<div class="container content-stack">
		<section class="workbench-hero" aria-labelledby="workbench-hero-title">
			...
			<h1 class="workbench-hero__title" id="workbench-hero-title"><?php esc_html_e( 'Clear editing. Dependable components.', 'acf-module-workbench' ); ?></h1>
			<p class="workbench-hero__introduction"><?php esc_html_e( 'Editors control content and meaningful variations. Each reusable component controls its layout, responsive behavior, accessibility, and presentation.', 'acf-module-workbench' ); ?></p>
			<div class="workbench-hero__actions">
				...
				<a class="workbench-text-link" href="#component-contract"><?php esc_html_e( 'See the approach', 'acf-module-workbench' ); ?><span class="workbench-text-link__icon" aria-hidden="true">→</span></a>
			</div>
		</section>
