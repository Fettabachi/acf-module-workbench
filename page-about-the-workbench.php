    ...
    <div class="container content-stack">
        ...
        <section class="workbench-about__section" aria-labelledby="workbench-principles-title">
            ...
            <div class="workbench-principles">
                <article>
                    <h3><?php esc_html_e('Accessible', 'acf-module-workbench'); ?></h3>
                    <p><?php esc_html_e('Semantic structure, keyboard operation, visible focus, useful names, sufficient contrast, and reduced-motion support are part of implementation—not a later audit.', 'acf-module-workbench'); ?></p>
                </article>
                <article>
                    <h3><?php esc_html_e('Portable', 'acf-module-workbench'); ?></h3>
                    <p><?php esc_html_e('Components avoid page IDs, site-specific URLs, generic class names, and hidden dependencies on one surrounding layout.', 'acf-module-workbench'); ?></p>
                </article>
                <article>
                    <h3><?php esc_html_e('Editor-friendly', 'acf-module-workbench'); ?></h3>
                    <p><?php esc_html_e('Controls reflect meaningful content decisions and are tested in the space editors actually use.', 'acf-module-workbench'); ?></p>
                </article>
                <article>
                    <h3><?php esc_html_e('Defensive', 'acf-module-workbench'); ?></h3>
                    <p><?php esc_html_e('Every field may be empty, every external response is untrusted, and the useful experience should survive missing data or unavailable JavaScript.', 'acf-module-workbench'); ?></p>
                </article>
            </div>
        </section>
        ...
        <section class="workbench-repository" aria-labelledby="workbench-repository-title">
            ...
            <a class="workbench-button" href="<?php echo esc_url(\ACF_Module_Workbench\WORKBENCH_REPOSITORY_URL); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('View the repository', 'acf-module-workbench'); ?></a>
        </section>
    </div>
</main>
<?php
